...
public class TextEditorDialogFragment extends DialogFragment {
  ...
  //  private TextView mAddTextDoneTextView;
    private FloatingActionButton actionDone;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
     ...
     //   mAddTextDoneTextView = view.findViewById(R.id.add_text_done_tv);
        actionDone = view.findViewById(R.id.actionDone);
     ...
     //   mAddTextDoneTextView.setOnClickListener(new View.OnClickListener()
          actionDone.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                actionDone.startAnimation(rotateAnimation);
                scheduleDoDone();
            }
        });

    }
    private void scheduleDoDone() {
        Handler handler = new Handler();
        handler.postDelayed(this::doDone, 250);
    }
    private void doDone() {
        dismiss();
